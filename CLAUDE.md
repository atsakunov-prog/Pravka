...
3. **Внизу ровно шесть кнопок (Правка · Засечка · Дело · Спорт · Еда · Ещё), плавающих ровно четыре (П · З · Д · Т).** Над
   ...
   **диском** вокруг шестерёнки (`trigger/DiskController.kt`,
   `core/DiskGeometry.kt`): крутится за любую кнопку, переезжает за шестерёнку
   по долгому нажатию, у края виден наполовину; тумблер «Диск вместо стопки»
   в Общих возвращает стопку. Новая
