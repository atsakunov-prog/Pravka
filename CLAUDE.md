...
- `slushalka/src/main/java/ru/zf/slushalka/`
  ...
  - `catalog/` — Флибуста по OPDS: `Opds.kt` (разбор Atom-ленты),
    ...
    `CatalogState.kt` (стопка лент, поиск, скачивание в
    `Флибуста/<Автор> - <Название>/` внутри библиотеки и перечитывание папки).
  ...
  - `ui/` — экраны: библиотека, плеер, читалка, вопрос, пересказ, настройки,
    каталог Флибусты (`CatalogScreen.kt`, вход — лупа на полке).
