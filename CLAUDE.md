...
3. **Внизу ровно шесть кнопок (Правка · Засечка · Дело · Спорт · Еда · Ещё), плавающих ровно четыре (П · З · Д · Т).** Над
   «П» — серая шестерёнка (0,72 кнопки), не кнопка режима: тап раскрывает
   веер быстрых настроек (модель чистки · микрофон · обновления · спрятать
   всё), «спрятать всё» сжимает стекло в точку с «П», едет за «П», как ручка
   под хвостом. Плашки микрофона между «П» и «З» и трёх точек над «П» больше
   нет (18.09.2026). С 19.09.2026 те же четыре кнопки по умолчанию стоят
   **диском** вокруг шестерёнки (`trigger/DiskController.kt`,
   `core/DiskGeometry.kt`): крутится за любую кнопку, переезжает за стекло
   (или за шестерёнку по долгому нажатию), у края виден до середины
   шестерёнки, двойной тап по шестерёнке — всё в точку «П»; выбор
