...
| Засечка: лента, два трека, категории, автопилот, NFC, Sheets, напоминания | `docs/zasechka.md` |
...
| Разборы: паттерны, дайджесты, CSV всей жизни, синк жизни в Notion | `docs/razbory.md` |
...
5. **Наружу пишем осторожно.** В Notion — только «Дневник» (свои колонки) и базы
   «Правка: разборы» (`NotionLifeSync`); в intervals не PUT-ить, не прочитав;
