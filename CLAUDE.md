...
| Деньги: кнопка «₽», траты голосом, выписки Тинькова/Альфы/МКБ/«Плати по миру», сверка и вопросы карточками, статистика и графики, «спросить Claude», паттерны, справочник получателей, книга «Деньги» | `docs/dengi.md` |
