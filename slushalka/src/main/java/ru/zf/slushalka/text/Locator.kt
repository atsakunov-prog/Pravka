...
object Locator {
    ...
    /**
     * Ступени окна для перехода: сперва ближайшие два-три абзаца вокруг
     * предполагаемого места, и только если там не нашлось - шире. Обычно хватает первой
     * ступени, а она считается почти мгновенно.
     */
    private val STAGES = intArrayOf(900, 2_500, 7_000, 18_000, DEFAULT_RADIUS)
