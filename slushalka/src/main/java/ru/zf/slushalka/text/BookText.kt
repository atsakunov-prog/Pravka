...
class BookText(
    ...
    companion object {
         ...
         */
        // 6: автор больше не склеивается с переводчиком (см. Fb2Parser).
        // Разобранный текст лежит в кэше, и без смены версии старые книги
        // остались бы с прежним колонтитулом.
