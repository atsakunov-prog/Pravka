 ...
 *
 * Плеер живёт дольше службы: он в Application, а службу на паузе система
 * вправе остановить. Поэтому её поднимают дважды - при открытии книги (чтобы
 * книга сразу легла в шторку) и на каждом пуске звука из PlayerHolder. Служба
 * должна спокойно переживать повторный старт поверх живой и создание заново
 * поверх уже загруженного плеера.
 */
