...
// «З» и «Д», та же плашка-тикер, те же жесты:
//   тап        -> говоришь что угодно про тело (тап ещё раз — разбор)
//   долгое     -> меню: сегодня, зарядка сделана, «Спорт», «Еда», текстом
//   перетаскивание -> четвёрка ездит связкой (П сверху, З, Д, Т снизу)
// Цвет — зелёные чернила рядом с оранжевым «П», янтарной «З» и синей «Д»:
...
class BodyButtonController(
    ...
    companion object {
        ...
        // синей «Д». Тёмный, «бутылочный» — на бумажном фоне он читается как
