...
private fun CommonSettings(app: PravkaApp, serviceEnabled: Boolean) {
    ...
    HintText(
        "Полминуты без касаний остаются две: «П» и «З» — они на своих местах " +
            "и работают как обычно, первый тап сразу пишет. «Д» и «Е» " +
            "схлопываются в «З». Вернуть их — серая ручка с галочкой под " +
            "стопкой; ею же можно свернуть и разложить когда угодно, не " +
            "дожидаясь полуминуты. Вторая серая ручка, с многоточием, стоит " +
            "над «П» и убирает с экрана ВСЁ разом — вместе со значками и " +
            "плашками; нажатие возвращает все четыре. Посреди записи или " +
            "разбора сами не складываются никогда."
    )
