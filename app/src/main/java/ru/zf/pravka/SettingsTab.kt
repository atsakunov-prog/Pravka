...
private fun CommonSettings(app: PravkaApp, serviceEnabled: Boolean) {
    ...
    HintText(
        "Круг: «П» сверху, «З» снизу, «Д» дальше — вокруг шестерёнки на стекле. " +
            ...
            "промежутки между кнопками) — диск переезжает; у края экрана прячется до " +
            ...
            "тап по свободному стеклу — тот же веер. Стопка: прежний столбик с " +
            "ручкой-галочкой. Зелёная «Е» выключена — вернуть её можно тумблером в " +
            "настройках Еды."
    )
