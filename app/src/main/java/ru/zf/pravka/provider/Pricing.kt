...
object Pricing {
    ...
    private val prices = mapOf(
        ...
        // Опус 5.5 дешевле Опуса 5: $4/$20, а чтение кэша — $0.20, двадцатая
        // часть входа, не десятая: по общему правилу вышло бы $0.40, и
        // кэшированная правка считалась бы вдвое дороже, чем есть. Опус 5
        // оставлен ради батчей, ушедших до обновления: их ответ приходит уже
        // в новую сборку.
        Settings.MODEL_OPUS to Price(4.0, 20.0, cacheRead = 0.20),
        Settings.MODEL_OPUS_5 to Price(5.0, 25.0),
