...
object Pricing {
    ...
    private val prices = mapOf(
        ...
        // Опус 5.5 дешевле Опуса 5: $4/$20, чтение кэша — как у всех, десятая
        // часть входа ($0.20). Опус 5 оставлен ради батчей, ушедших до
        // обновления: их ответ приходит уже в новую сборку.
        Settings.MODEL_OPUS to Price(4.0, 20.0),
