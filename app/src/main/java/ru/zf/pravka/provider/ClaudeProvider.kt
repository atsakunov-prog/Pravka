...
- "category": название категории из списка, БУКВА В БУКВУ (без «кавычек»
  ...
  списках выше уже лежит в какой-то категории — клади в неё же, не
  рассуждай заново («YouTube» шёл в Потери — значит Потери, даже если
  «Отдых» кажется тебе логичнее; различия вида «Лежу в кровати» = Отдых,
  а «Ничего не делаю» = Потери — его решения, не твои). «Не размечено» —
  техническая категория авто-заполнителя дыр: сам её НЕ выбирай никогда.
  Если ничего не подходит — пустая строка.
