...
object MoneyCategories {
    ...
    val ALL: List<Category> = listOf(
        ...
        // «Перевод округлений» на накопительный: Т-Банк округляет покупку и
        // кладёт копейки в копилку в ту же секунду — в выписке это строка на
        // копилке, а списание с карты — только колонкой «Округление».
        Category("roundup", "Округления в копилку", G_SERVICE, Shelf.SERVICE),
    )
