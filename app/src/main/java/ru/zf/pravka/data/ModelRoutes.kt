...
enum class ModelRoute(
    ...
    NIGHT_REVIEW(
        ...
        "В ночь на пятницу за неделю (и каждую ночь за сутки, если включено) по журналам: ослышки, словарь, поведение модели, правила. Батчем — вдвое дешевле; мысли на high — три четверти цены, заводское medium.",
